...
GITHUB_RAW_URL = "https://raw.githubusercontent.com/antic-pankaj/Vuln-Scanner/main/vulnscanner.py"
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if remote_code != local_code:
                ...
                # Relaunch updated script
                os.execv(sys.executable, [sys.executable] + sys.argv)
            else:
                print("[*] You are running the latest version.")
        else:
            print("[!] Failed to check updates: HTTP", response.status_code)
